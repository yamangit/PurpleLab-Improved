...
curl_setopt($curl_ip, CURLOPT_CONNECTTIMEOUT, 1);
curl_setopt($curl_ip, CURLOPT_TIMEOUT, 2);
...
<div class="nav-bar">
    ...
    <ul>
        ...
        <li><a href="health.php" class="active"><i class="fas fa-heartbeat"></i> <span>Health</span></a></li>
